...
class YTEmoticonTipView: UIImageView {

    /// 之前选择的表情
    private var preEmoticon: YTEmoticon?
    
    /// 提示视图的表情模型
    var emoticon:YTEmoticon? {
        didSet {
            // 判断表情是否变化
    ...
    // MARK: - 构造函数
    init() {
        let bundle = YTEmoticonManager.shared.bundle
